...
class depthLimitedSearchDumpFile():
    ...
    def dls(self, startState, goalState, zeroValIndex,depth,f):
        f.write("Method Selected: dls\n")
        f.write("Running dls\n")
        queue = deque()
        ...
        while queue:
            ...
            if level > int(depth):
                print("Specified Depth Limited Exceeded")
                return
