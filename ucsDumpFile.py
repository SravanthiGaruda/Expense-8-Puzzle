...
class ucsMethodDumpFile():
    ...
    def printSolutionSteps(matrixRootNode):
        ...
        ucsMethodDumpFile.printSolutionSteps(matrixRootNode.matrix)  
        if matrixRootNode.action != "Start":
            print(matrixRootNode.action)

    # Main code starts from here!
    def ucs(self, startState, goalState, zeroValIndex,f):

        f.write("Method Selected: ucs")
        f.write("\nRunning ucs")
        f.write("\n")
        heap = []
        closed_set = []
        ...
        while heap:
            ...
            if goalState == current_matrix:
                ...
                print("Steps: ")
                ucsMethodDumpFile.printSolutionSteps(temp_matrixNode)
                return 
